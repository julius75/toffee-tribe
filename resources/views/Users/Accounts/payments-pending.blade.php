    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <p style="text-align: center">Once paid and you have received an M-PESA confirmation, click <a class="btn btn-sm btn-success" href="{{route('checks.mpesa.confirms', ['orderId'=>encrypt($order->id)])}}">Finish</a></p>
            </div>
...
<script>
    ...
    //         $.ajax({
    //             method: "GET",
    //             url: "{{route('checks.mpesa',['orderId'=>encrypt($order->id)])}}",
