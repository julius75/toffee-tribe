    ...
    <div class="row justify-content-center">
        <div class="card col-md-10">
            <div class="card-body">
                ...
                <div class="row">
                    <h3 class="mt-4" style="color: #1a9082">ORDER INVOICE</h3>
                </div>
                <div class="row">
                    <h4 class="mt-4" style="color: #1a9082">Order Description</h4>
                </div>
                <div class="row">
                    <div class="col-md-8">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>{{\Carbon\Carbon::parse($exp_date)->format('d M Y')}} <small style="font-size: 10px; color: #1a9082">END OF DAY</small></td>
