        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" class="prevent-m-subs" action="{{ route('user.register') }}">
                            ...
                            <div class="form-group row">
                                <label for="location" class="col-md-4 col-form-label text-md-right">Location User is based: </label>
                            ...
                            <div class="form-group row">
                                <label for="grind" class="col-md-4 col-form-label text-md-right">User Occupation: </label>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn btn-secondary btn-sm button-prevent">
                                        Register
                                    </button>
                                </div>
                            </div>
