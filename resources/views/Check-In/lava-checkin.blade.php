@extends('layouts.checkIn')
    @section('title', 'LAVA LATTE Check In')
...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="text-center">
                <h5 class="text-white mb-3">Welcome to Lava Latte!</h5>
    ...
    <div class="row justify-content-center">
        <div class="col-md-9 col-xs-8">
                    <div class="row justify-content-center">
                            <div class="text-center">
                                <img src="{{asset('QR-checkin/lavalatte.png')}}" style="width: 70%; height: 100%" alt="Image not found">
                            </div>
                    </div>
            </div>
        </div>
