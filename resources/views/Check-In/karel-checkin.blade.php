...
@section('title', 'KAREL-T LOUNGE Check In')
...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        <div class="text-center">
            <h5 class="text-white mb-3">Welcome to Karel-T Lounge!</h5>
    ...
    <div class="row justify-content-center">
        <div class="col-md-9 col-xs-8">
                    <div class="row justify-content-center">
                            <div class="text-center">
                                <img src="{{asset('QR-checkin/karel.jpeg')}}" style="width: 70%; height: 100%" alt="Image not found">
                            </div>
                        </div>
            </div>
        </div>
