$(document).ready(function () {
    ...
    $('#custom-print-msg').DataTable({
        dom: 'Bfrtip',
        buttons: [{extend: 'print', message: 'List of total order in this month by Flat - Admin'}]
    });
    $('#print-disable').DataTable({dom: 'Bfrtip', buttons: [{extend: 'print', autoPrint: false}]});
    ...
    $('#print-row').DataTable({
        dom: 'Bfrtip',
        buttons: [{extend: 'print', text: 'Print all'}, {
            extend: 'print',
            text: 'Print selected',
    ...
    $('#flash-export').DataTable({dom: 'Bfrtip', buttons: ['copyFlash', 'csvFlash', 'excelFlash', 'pdfFlash']});
    $('#file-export').DataTable({
        dom: 'Bfrtip',
        buttons: [{extend: 'excelFlash', filename: 'my-Excel'}, {extend: 'pdfFlash', filename: 'my-PDF'}]
    });
    $('#flash-pdf-msg').DataTable({
        dom: 'Bfrtip',
        buttons: [{extend: 'pdfFlash', message: 'PDF created by Buttons for DataTables.'}]
    });
    $('#flash-size').DataTable({
        dom: 'Bfrtip',
        buttons: [{extend: 'pdfFlash', orientation: 'landscape', pageSize: 'LEGAL'}]
    });
    ...
    $('#pdf-open').DataTable({dom: 'Bfrtip', buttons: [{extend: 'pdfHtml5', download: 'open'}]});
    $('#pdf-json').DataTable({
        dom: 'Bfrtip', buttons: [{
    ...
    $('#basic-btn').DataTable({dom: 'Bfrtip', buttons: ['copy', 'csv', 'excel', 'pdf', 'print']});
    $('#custom-btn').DataTable({
        dom: 'Bfrtip',
        buttons: [{
            text: 'My Custom button', action: function (e, dt, node, config) {
    ...
    $('#class-btn').DataTable({
        dom: 'Bfrtip',
        buttons: [{text: 'Warning', className: 'btn-warning'}, {
            text: 'Danger',
    ...
    $('#keyboard-btn').DataTable({
        dom: 'Bfrtip',
        buttons: [{
            text: 'Button <u>1</u>', key: '1', action: function (e, dt, node, config) {
                alert('Button 1 activated');
            }
        }, {
            text: 'Button <u><i>alt</i> 2</u>', key: {altKey: true, key: '2'}, action: function (e, dt, node, config) {
    ...
    $('#multilevel-btn').DataTable({
        ...
        buttons: [{
            ...
            text: 'Table control',
            buttons: [{
                text: 'Toggle start date', action: function (e, dt, node, config) {
                    dt.column(-2).visible(!dt.column(-2).visible());
                }
            }, {
                text: 'Toggle salary', action: function (e, dt, node, config) {
    ...
    var table = $('#multibtn-grup').DataTable({
        dom: 'Bfrtip',
        buttons: [{
            text: 'Button 1', action: function (e, dt, node, config) {
