...
$.fn.pcodedmenu = function(settings) {
    ...
    var defaults = {
        ...
        NavbarBackground: 'themelight1', // Value should be theme1/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        ...
        HandleThemeBackground: function() {
            ...
            function setactiveitemtheme() {
                ...
                if (ev != undefined && ev != "") {
                    ...
                    $('#' + oid + ' .pcoded-navbar').attr("active-item-theme", "themelight1");
                }
            };
