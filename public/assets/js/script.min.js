...
$(document).ready(function () {
    ...
    $(".main-friend-list").slimScroll({
        ...
        if ("right" == $(".pcoded").attr("vertical-placement")) var e = {direction: "left"}; else var e = {direction: "right"};
